...
import Nav_Eng from './Nav';
import Footer_Eng from './Footer';
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="title" property="og:title" content="David Luque | Porfolio personal"/>
                <meta name="description" property="og:description" content="Porfolio personal de David Luque"/>
