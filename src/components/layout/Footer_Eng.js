...
import resumeFile from '../../../public/static/david-luque-resume-eng.pdf';
...
const Footer = () => {
    ...
    return (
        <footer className="footer">
            <h4 className="footer__copyright">Developed by David Luque - All rights reserved &copy; - {year} </h4>
